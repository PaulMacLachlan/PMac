...
console.log(dojo.name, dojo["number_of_students"], dojo.instructors, dojo.location.state, dojo.location.zipcode);
console.log(dojo["name"]);                     // or bracket [] notation (note: specify key in quotes)<br>
